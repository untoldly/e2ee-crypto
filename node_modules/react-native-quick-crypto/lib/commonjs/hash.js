...
const asyncDigest = async (algorithm, data) => {
  ...
  if (name === 'cSHAKE128' || name === 'cSHAKE256') {
    if (typeof algorithm.length !== 'number' || algorithm.length <= 0) {
      throw (0, _errors.lazyDOMException)('cSHAKE requires a length parameter', 'OperationError');
    }
    if (algorithm.length % 8) {
      throw (0, _errors.lazyDOMException)('Unsupported CShakeParams length', 'NotSupportedError');
    }
