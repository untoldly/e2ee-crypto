...
import { HashContext, binaryLikeToArrayBuffer, bufferLikeToArrayBuffer, lazyDOMException, normalizeHashName } from './utils';
...
function getNative() {
  if (native == null) {
    ...
    native = NitroModules.createHybridObject('Pbkdf2');
  }
  return native;
}
